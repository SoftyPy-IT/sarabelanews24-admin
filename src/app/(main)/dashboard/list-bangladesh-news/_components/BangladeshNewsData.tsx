...
const BangladeshNewsData = () => {
  ...
  const handleEdit = (rowData: any) => {
    router.push(
      `/dashboard/list-bangladesh-news/update-details/${rowData?.id}`
    );
  };
  ...
  const handleView = (rowData: any) => {
    router.push(`/dashboard/list-bangladesh-news/view-details/${rowData?.id}`);
...
export default BangladeshNewsData;
