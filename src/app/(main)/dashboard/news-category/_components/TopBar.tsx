...
const TopBar = () => {
  ...
  return (
    <>
      <div className="flex flex-wrap justify-between items-center bg-white lg:p-4 rounded mb-5 gap-4 md:gap-8">
        {/* Header Section */}
       ...
       <Sheet>
          {/* <SheetTrigger id="add-category-sheet-trigger" asChild> */}
