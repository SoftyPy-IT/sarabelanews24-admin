...
const TopBar = () => {
  ...
  return (
    <>
      <div className="flex justify-between items-center content-center bg-white p-2  border shadow-sm mb-5 gap-2 md:gap-0 rounded-md">
        <div className="space-y-2 py-2">
          <h2 className="text-sm md:text-3xl pl-2 font-semibold">Add Lead News</h2>
        </div>
