...
const Aside = ({ toggleSidebar }: { toggleSidebar: () => void }) => {
  ...
  const allRoutes = [
    ...
    },
    {
      ...
      icon: ImageIcon,
      children: [
        { href: "/dashboard/add-photo-news", label: "Add Photo News", icon: PlusIcon },
        { href: "/dashboard/list-photo-news", label: "Photo News List", icon: List },
      ],
    },
    {
      href: "/video",
    ...
    },
    {
      ...
      icon: NotebookIcon,
      children: [
        { href: "/dashboard/add-advertisement", label: "Add Advertisement", icon: PlusIcon },
        { href: "/dashboard/list-advertisement", label: "Advertisement List", icon: List },
      ],
    },
    {
      href: "/img",
      ...
      children: [
        { href: "/dashboard/gallery/all-img", label: "All Images", icon: ImageIcon },
    ...
    },
    {
      ...
      restricted: true,
      children: [
        { href: "/dashboard/backup", label: "Backup Database", icon: DatabaseBackup },
        { href: "/dashboard/restore", label: "Restore Database", icon: ArchiveRestore },
      ],
    },
  ];
  ...
  return (
    <aside className="text-white">
      <div className="text-center pt-3">
        ...
        >
          <Image src={logo} alt="dailytimes24" width={130} height={100} priority />
        </Link>
      </div>
      ...
      <nav>
        <Accordion type="single" collapsible className="space-y-4">
          {routes.map((route, i) => (
            <AccordionItem key={i} value={route.href} className="border-none">
              {route.children ? (
                <>
                  <AccordionTrigger
                    className={cn(
